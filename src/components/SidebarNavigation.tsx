...
/**
 * SidebarNavigation component for application navigation
 * Provides collapsible vertical navigation with section support
 */
                  ...
                  {item.children.map((child) => (
                    <li key={child.path}>
                      <button
                        ...
                        className={`w-full flex items-center space-x-3 py-1.5 px-3 rounded-md text-sm transition-colors ${location.pathname === child.path ? "text-primary" : "hover:bg-muted"}`}
                      >
